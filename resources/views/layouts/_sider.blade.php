            ...
            <ul class="navbar-nav">        
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li><a href="{{ route('users.edit', Auth::user()) }}">信息修改</a></li>
                  </ul>
              </li>
              <li class="nav-item dropdown">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      <li><a href="{{ route('topics.index') }}">查看公告</a></li>
                      @if(Auth::user()->is_admin == 1)
                      <li><a href="{{ route('topics.create', array('is_admin'=> Auth::check() ? Auth::user()->is_admin : 0)) }}">发布公告</a></li>
                      @else
                      @endif
                  </ul>
              </li>
              @if(Auth::user()->is_admin == 1)
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      <li><a href="{{ route('inform', Auth::user()) }}">个人私信</a></li>
                      <li><a href="{{ route('users.index', Auth::user()) }}">用户查阅</a></li>
                      <li><a href="{{ route('adduser') }}" >添加用户</a></li>
                  </ul>
              </li>
              @else
              @endif
